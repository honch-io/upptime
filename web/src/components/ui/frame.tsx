// coss ui — Frame (https://coss.com/ui/docs/components/frame)
// A framed container for grouping related information. Vendored per coss ui's
// "copy, paste, and own" model; only the cn import path is adapted.
