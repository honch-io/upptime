// coss ui — Dialog (Base UI)
// Vendored from coss ui. The DialogPanel (ScrollArea-backed) variant is omitted
// here since the subscribe modal needs no internal scroll region; everything
